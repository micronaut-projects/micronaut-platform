...
micronautBom {
    ...
    suppressions {
        ...
        dependencies.add("io.micronaut.oraclecloud:micronaut-oraclecloud-bmc-datalabelingservicedataplane:5.3.1")
        ...
        dependencies.add("io.micronaut.oraclecloud:micronaut-oraclecloud-bmc-genericartifactscontent:5.2.1")
