...
Bill of Materials (BOM) and Gradle version catalogs for Micronaut projects.
...
* [Publish the draft release](https://github.com/micronaut-projects/micronaut-platform/releases). There should be already a draft release created, edit and publish it. The Git Tag should start with `v`. For example `v1.0.0`.
* [Monitor the Workflow](https://github.com/micronaut-projects/micronaut-platform/actions?query=workflow%3ARelease) to check it passed successfully.
* If everything went fine, [publish to Maven Central](https://github.com/micronaut-projects/micronaut-platform/actions?query=workflow%3A"Maven+Central+Sync").
* Celebrate!
